...
function App() {
  ...
  const handleSubmitForm = () => {
    ...
    const encodedData = encode({
      ...
      bairroDeConstrucao: propData.bairroDeConstrucao,
      temProjeto: propData.temProjeto,
      suiteMaster: 0,
      suite: amoutData.suite,
      quarto: amoutData.quarto,
      salaDeEstar: amoutData.salaDeEstar,
      escritorio: amoutData.escritorio,
      cozinha: amoutData.cozinha,
      salaDeJantar: amoutData.salaDeJantar,
      lavabo: amoutData.lavabo,
      home: 0,
      areaGourmet: amoutData.areaGourmet,
      garagemCoberta: amoutData.garagemCoberta,
      roupeiro: amoutData.roupeiro,
      deposito: amoutData.deposito,
      ...
      >
        <form onSubmit={handlePropSubmit(() => setStep((e) => e + 1))}>
          <div className="p-4 flex flex-col gap-2">
            ...
            <InputSelect
              options={[
                { label: 'Não possuo terreno', value: 'Não possuo terreno' },
